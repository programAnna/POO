public class Consulta {
    private String hora;
    private String data;
    private Medico medico;      //agregacao
    private Paciente paciente;  //agregacao
    private String motivo;
    private String historico;
    private Agenda agenda;      //agregacao
    private Receita receita;    //agregacao
    private Exame exame;        //exame
